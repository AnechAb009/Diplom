...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SugarKit/SugarKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SuperPuperDuperLayout/SuperPuperDuperLayout.framework"
